...
<div class="container-fluid">
  <div class="row">
	...
	<div class="row">
		<div class="large-12 columns">
      <form class="form-horizontal" role="form" method="POST" action="{{ url('doctor/blog/update/'.$blog->getObjectId()) }}" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">

        <div class="form-group">
          <label class="col-md-4 control-label">Blog Title</label>
          <div class="col-md-6">
            <input type="text" class="form-control" name="name" placeholder="Blog Title" value="{{$blog->get('name')}}">
          </div>
        </div>
